        ...
        return (
            <View style={SignUpStyles.container}>
                ...
                {Object.keys(userInterest).map((key, index) => {
                    return(
                        <View key = {index} style={[{ width: width(100), flexDirection: 'column', marginTop: height(1), marginBottom:height(2), justifyContent: 'space-between', height: height(15), backgroundColor: "#dedfde" }]}>
                            ...
                            <View key = {index} style={{ width: width(100), flexDirection: 'row', height: height(5), backgroundColor: "#dedfde", marginLeft: width(5), justifyContent: 'flex-start' }}>
